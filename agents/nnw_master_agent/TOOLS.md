...
- To spawn: `python skills/manage_writer.py spawn --theme "THEME_HERE" --name "AGENT_NAME" --personality "TRAITS_HERE"`
- To kill: `python skills/manage_writer.py kill --name "AGENT_NAME"`
